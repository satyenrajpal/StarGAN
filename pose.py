...
class Solver_pose(object):
    ...
    def train(self):
        ...
        x_fixed, _, c_org = next(data_iter)
        ...
        for i in range(start_iters, self.num_iters):
            ...
            d_loss_cls = self.classification_loss(out_cls[0], label_org.squeeze(1).long())
            ...
            if (i+1) % self.n_critic == 0:
                ...
                g_loss_cls = self.classification_loss(out_cls[0], label_trg.squeeze().long())
